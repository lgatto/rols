...
(alltgns <- OlsSearch(q = "trans-golgi network", exact = TRUE))
(alltgns <- OlsSearch(q = "trans-golgi network", ontology = "GO"))
(alltgns <- OlsSearch(q = "trans-golgi network", ontology = "GO", exact = TRUE))
```
...
The description of the `r length(onto.tab)` ontologies of interest can
then be used to subset the ontology description:
